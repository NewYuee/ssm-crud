...
<head>
    ...
    %>
    <%--    不以/开始的相对路径找资源，以当前资源的路径为基准，容易出问题--%>
    <%--    以/开始的相对路径找资源以服务器的路径为标准(http://localhost:3306);需要加上项目名--%>
...
/*        <button class="btn btn-primary">
    ...
    function build_page_info(result) {
        ...
        $("#page_info_area").append("共"+result.extend.pageInfo.total+"条数据,当前"+result.extend.pageInfo.pageNum+"/"+result.extend.pageInfo.pages+"页");
    ...
    function validate_add_form(){
        ...
        if(!regName.test(empName)){
            ...
            show_validate_msg("#empName_add_input","error","用户名可以是2-5位中文或者6-16位英文数字组合");
            return false;
        }else {
            ...
            success:function (result) {
                ...
                to_page(totalRecord);
                    ...
                    if(undefined !="result.extend.errorFileds.empName"){
                        //显示员工名字错误信息
                        show_validate_msg("#emp_add_input","error",result.extend.errorFileds.empName);
                    }
                }
            }
        });
    ...
    $("#check_all").click(function () {
        ...
        //我们这些dom原生的属性，attr获取自定义属性的值；所以建议用prop修改dom原生属性的值
